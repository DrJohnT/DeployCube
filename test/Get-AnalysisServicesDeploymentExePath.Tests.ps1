...
Describe "Get-AnalysisServicesDeploymentExePath"  -Tag "Round1" {
    ...
    Context "Testing Inputs" {
        It "Should have Version as a mandatory parameter" {
            (Get-Command Get-AnalysisServicesDeploymentExePath).Parameters['Version'].Attributes.mandatory | Should -BeTrue;
        }
    }
    ...
    Context "Finding Microsoft.AnalysisServices.Deployment.exe version" {
        ...
        It "Finds version 15" {
            ResetEnv;
            ( Get-AnalysisServicesDeploymentExePath -Version 15 ) -like "*Microsoft.AnalysisServices.Deployment.exe" | Should -BeTrue;
        }

        It "Does not find version 14" {
            ResetEnv;
            ( Get-AnalysisServicesDeploymentExePath -Version 14 ) -like "*Microsoft.AnalysisServices.Deployment.exe" | Should -BeFalse;
        }

        It "Does not find version 13" {
            ResetEnv;
            ( Get-AnalysisServicesDeploymentExePath -Version 13 ) -like "*Microsoft.AnalysisServices.Deployment.exe" | Should -BeFalse;
        }

        It "Does not find version 12" {
            ResetEnv;
            ( Get-AnalysisServicesDeploymentExePath -Version 12 ) -like "*Microsoft.AnalysisServices.Deployment.exe" | Should -BeFalse;
        }

        It "Does not find version 11"  {
            ResetEnv;
            ( Get-AnalysisServicesDeploymentExePath -Version 11 ) -like "*Microsoft.AnalysisServices.Deployment.exe" | Should -BeFalse;
        }
        ...
        It "Valid folder location and Microsoft.AnalysisServices.Deployment.exe present" {
            ...
            ( Get-AnalysisServicesDeploymentExePath -Version 11 ) -like "*Microsoft.AnalysisServices.Deployment.exe" | Should -BeTrue;
        }
    }
}
