...
function Publish-Cube {
    <#
		.SYNOPSIS
        Publish-Cube deploys a tabular or multidimenstional cube to a SQL Server Analysis Services instance.
    ...
    try {
        ...
        if (Ping-SsasServer -ServerName $TargetServerName) {
            ...
            Write-Verbose "Publish-Cube: Deploying cube '$TargetDatabaseName' to server '$TargetServerName' using AsDatabase file '$AsDatabasePath'. Processing option: $ProcessingOption";
            ...
            throw "Invalid TargetServerName: $TargetServerName";
        }
    } catch {
        throw "Error: $_";
    }
